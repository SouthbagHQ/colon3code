...
`~/.colon3code/userdata/keybindings.json` by default. You can edit this file directly.
...
:3 Code creates the file with its defaults and adds new defaults on later startups.
...
Invalid rules are ignored; if the file cannot be parsed, :3 Code uses defaults.
