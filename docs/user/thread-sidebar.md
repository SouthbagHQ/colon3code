...
When you change a new thread's project, :3 Code stays in the current environment
...
If dragging is unavailable for one environment, update the :3 Code server running in that
