...
also send files to :3 Code through another app's system share sheet.
...
:3 Code remembers your provider, model, and model options for new threads. A
...
Transcription runs on your device. :3 Code deletes the temporary audio after
...
Provider commands must start the message to run. :3 Code commands such as
...
complete :3 Code tells you and leaves the chip for you to remove or replace. A chip whose
...
automatically. HTML previews cannot access your :3 Code session.
