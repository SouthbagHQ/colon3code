...
Both instances must use the same **CODEX_HOME path**. :3 Code prepares the shared
...
Choose the other account from the thread's model picker. :3 Code offers compatible
