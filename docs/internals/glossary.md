...
Terms whose meaning matters across :3 Code. Architecture and lifecycle constraints belong in the
...
| Term                | Meaning                                                                                                      |
| ------------------- | ------------------------------------------------------------------------------------------------------------ |
| Provider            | The agent runtime :3 Code controls, such as Codex or Claude Code.                                            |
...
| Adapter             | The boundary translating a provider's native protocol into :3 Code operations and events.                    |
