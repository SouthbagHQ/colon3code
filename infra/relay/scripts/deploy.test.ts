...
describe("reconcileRootEnvPublicConfig", () => {
  const config = {
    ...
    mobileTracingUrl: "https://api.axiom.co/v1/traces",
    mobileTracingDataset: "colon3-code-mobile-traces-dev",
    mobileTracingToken: "xaat-public-ingest",
    clientTracingUrl: "https://api.axiom.co/v1/traces",
    clientTracingDataset: "colon3-code-relay-client-traces-dev",
  ...
  it("adds the complete local client config", () => {
    expect(reconcileRootEnvPublicConfig("", config)).toBe(
      [
        ...
        "COLON3CODE_MOBILE_OTLP_TRACES_DATASET=colon3-code-mobile-traces-dev",
        "COLON3CODE_MOBILE_OTLP_TRACES_TOKEN=xaat-public-ingest",
        "COLON3CODE_RELAY_CLIENT_OTLP_TRACES_URL=https://api.axiom.co/v1/traces",
        "COLON3CODE_RELAY_CLIENT_OTLP_TRACES_DATASET=colon3-code-relay-client-traces-dev",
        "COLON3CODE_RELAY_CLIENT_OTLP_TRACES_TOKEN=xaat-relay-client-ingest",
        "",
      ].join("\n"),
    );
  });
  ...
  it("replaces stale values while preserving unrelated entries", () => {
    expect(
      reconcileRootEnvPublicConfig(
        [
          "COLON3CODE_CLERK_PUBLISHABLE_KEY=pk_test_example",
          "COLON3CODE_RELAY_URL=https://old.example.test",
          "COLON3CODE_MOBILE_OTLP_TRACES_URL=https://old.example.test/v1/traces",
          "COLON3CODE_MOBILE_OTLP_TRACES_DATASET=old-dataset",
          "COLON3CODE_MOBILE_OTLP_TRACES_TOKEN=old-token",
          "COLON3CODE_RELAY_CLIENT_OTLP_TRACES_URL=https://old.example.test/v1/traces",
          "COLON3CODE_RELAY_CLIENT_OTLP_TRACES_DATASET=old-client-dataset",
          "COLON3CODE_RELAY_CLIENT_OTLP_TRACES_TOKEN=old-client-token",
          "",
        ].join("\n"),
        config,
      ),
...
describe("serializeRelayClientTracingEnvironment", () => {
  it("serializes tracing config for downstream GITHUB_ENV loading", () => {
    expect(
      ...
      [
        "COLON3CODE_RELAY_CLIENT_OTLP_TRACES_URL=https://api.axiom.co/v1/traces",
        "COLON3CODE_RELAY_CLIENT_OTLP_TRACES_DATASET=relay",
        "COLON3CODE_RELAY_CLIENT_OTLP_TRACES_TOKEN=client-token",
        "",
      ].join("\n"),
    );
  });
