...
const DATABASE_NAME = "colon3code:connection-runtime";
...
const GITHUB_ROUTING_KEY_PREFIX = "colon3code:github-routing:";
const GITHUB_ROUTING_CHANGED = "colon3code:github-routing-changed";
