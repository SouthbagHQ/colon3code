...
export const PERSISTED_STATE_KEY = "colon3code:ui-state:v1";
// Version 1 stored card visibility, not folder expansion.
const THREAD_CHANGED_FILES_EXPANSION_VERSION = 2;
const LEGACY_PERSISTED_STATE_KEYS = [
  "colon3code:renderer-state:v8",
  "colon3code:renderer-state:v7",
  "colon3code:renderer-state:v6",
  "colon3code:renderer-state:v5",
  "colon3code:renderer-state:v4",
  "colon3code:renderer-state:v3",
