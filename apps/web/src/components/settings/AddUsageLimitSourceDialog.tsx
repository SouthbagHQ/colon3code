  ...
  return (
    ...
    >
      <DialogPopup className="max-w-md">
        <DialogHeader>
          <DialogTitle>add a CLIProxyAPI hub :3</DialogTitle>
          <DialogDescription>
            show the quota of every account the hub pools, next to the providers on ;3
            {environmentLabel}. the key stays on that server :3
          </DialogDescription>
        </DialogHeader>
        <DialogPanel>
          <form
