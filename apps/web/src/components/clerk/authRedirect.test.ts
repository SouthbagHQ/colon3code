  ...
  it("removes a Clerk virtual pathname and callback params while preserving the desktop route", () => {
    expect(
      resolveClerkSignInProps(
        "colon3code://app/CLERK-ROUTER/VIRTUAL/sign-up?__clerk_status=complete#/settings/connections",
        true,
      ),
    ).toEqual({
      forceRedirectUrl: "colon3code://app/#/settings/connections",
      signUpForceRedirectUrl: "colon3code://app/#/settings/connections",
    });
  });

  it("preserves a clean development desktop route", () => {
    expect(resolveClerkSignInProps("colon3code-dev://app/#/settings/general", true)).toEqual({
      forceRedirectUrl: "colon3code-dev://app/#/settings/general",
      signUpForceRedirectUrl: "colon3code-dev://app/#/settings/general",
    });
  });
});
