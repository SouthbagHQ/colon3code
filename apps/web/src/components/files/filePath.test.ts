...
describe("fileBreadcrumbs", () => {
  it("builds project, directory, and file crumbs", () => {
    expect(fileBreadcrumbs("colon3code", "apps/web/src/main.tsx")).toEqual([
      { label: "colon3code", path: "", kind: "project" },
  ...
  it("starts host paths outside the workspace at the filesystem root", () => {
    expect(fileBreadcrumbs("colon3code", "/tmp/t3-cleanup/report.md")).toEqual([
    ...
    expect(fileBreadcrumbs("colon3code", "C:\\Temp\\report.md")).toEqual([
      { label: "C:", path: "C:", kind: "directory" },
      { label: "Temp", path: "C:\\Temp", kind: "directory" },
      { label: "report.md", path: "C:\\Temp\\report.md", kind: "file" },
    ]);
    expect(
      fileBreadcrumbs("colon3code", "\\\\server\\share\\report.md").map((c) => c.path),
