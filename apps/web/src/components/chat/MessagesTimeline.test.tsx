...
describe("MessagesTimeline", () => {
  ...
  it("renders elapsed time for a completed turn", () => {
    ...
    expect(markup).toContain("all done in 8.0s ^w^");
  });
  ...
  it("anchors the first user message using its measured height", () => {
    ...
    expect(markup).toContain("colon3code — Tests");
  ...
  it("does not render window details before the preview URL resolves", () => {
    ...
    expect(markup).not.toContain("colon3code — Tests");
  ...
  it("does not render collapse controls for short user messages", () => {
    ...
    expect(markup).toContain("rounded-2xl bg-message p-4");
  });
        ...
        timelineEntries={[
          {
            ...
            entry: {
              ...
              label: "Updated files",
              tone: "tool",
              changedFiles: ["C:/Users/mike/dev-stuff/colon3code/apps/web/src/session-logic.ts"],
            },
          },
        ]}
        workspaceRoot="C:/Users/mike/dev-stuff/colon3code"
      />,
    );
