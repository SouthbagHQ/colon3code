...
function Input({
  ...
  const inputClassName = cn(
    "h-9.5 w-full min-w-0 rounded-[inherit] px-[calc(--spacing(4)-1px)] leading-9.5 outline-none placeholder:text-placeholder sm:h-8.5 sm:leading-8.5 [transition:background-color_5000000s_ease-in-out_0s]",
    size === "compact" && "h-8 px-[calc(--spacing(3)-1px)] text-xs leading-8 sm:h-8 sm:leading-8",
    size === "sm" && "h-8.5 px-[calc(--spacing(3.5)-1px)] leading-8.5 sm:h-7.5 sm:leading-7.5",
    size === "lg" && "h-10.5 leading-10.5 sm:h-9.5 sm:leading-9.5",
    props.type === "search" &&
