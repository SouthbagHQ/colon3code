...
describe("buildCommandPaletteProjectMetadata", () => {
  ...
  it("makes every member environment and path searchable", () => {
      ...
      projects: [
        {
          ...
          title: ":3 Code",
          workspaceRoot: "/Users/theo/Projects/colon3code",
        },
        {
          environmentId: remoteEnvironmentId,
          title: "colon3code",
          workspaceRoot: "/srv/colon3code",
        },
      ],
    ...
    expect(metadata.searchTerms).toEqual([
      ":3 Code",
      "/Users/theo/Projects/colon3code",
      "Local",
      "colon3code",
      "/srv/colon3code",
      "Build box",
  ...
  it("deduplicates grouped checkouts by environment", () => {
    const metadata = buildCommandPaletteProjectMetadata({
      projects: [
        ...
        {
          environmentId: remoteEnvironmentId,
          title: ":3 Code worktree",
          workspaceRoot: "/srv/colon3code-feature",
        },
      ],
      locationByEnvironmentId: locations,
    });
    ...
    const metadata = buildCommandPaletteProjectMetadata({
      projects: [
        ...
        },
        {
          ...
          title: ":3 Code mirror",
          workspaceRoot: "/srv/mirror/colon3code",
        },
      ],
...
describe("buildThreadActionItems", () => {
  ...
  it("keeps message excerpts searchable without replacing thread metadata", () => {
    const [item] = buildThreadActionItems({
      ...
      projectTitleById: new Map([[PROJECT_ID, ":3 Code"]]),
      sortOrder: "updated_at",
      icon: null,
      getContentMatch: () => ({
        source: "assistant",
    ...
    expect(item?.description).toBe(":3 Code · #feat/search");
  });
  ...
  it("prefers renderDescription when provided", () => {
    ...
    expect(item?.description).toBe(":3 Code:feat/search:wt");
  });
...
it.each([
  "#10839",
  "10839",
  "SouthbagHQ/colon3code#10839",
  "https://github.com/SouthbagHQ/colon3code/pull/10839",
        ...
        pullRequests: [
          {
            ...
            number: 10839,
            url: "https://github.com/SouthbagHQ/colon3code/pull/10839",
            source: "manual",
