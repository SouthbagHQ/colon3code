...
describe("groupOnboardingProjects", () => {
  it("groups clones by origin, keeps local repos separate, and folds non-git folders away", () => {
    const main = candidate("/code/colon3code", {
      git: github("SouthbagHQ/colon3code"),
      threadCount: 79,
      lastActiveAt: "2026-08-21T12:00:00.000Z",
    });
    const clone = candidate("/code/clones/colon3code-2", {
      git: github("SouthbagHQ/colon3code"),
      threadCount: 13,
    ...
    expect(
      ...
      {
        label: "SouthbagHQ/colon3code",
        paths: ["/code/colon3code", "/code/clones/colon3code-2"],
        threadCount: 92,
        lastActiveAt: "2026-08-21T12:00:00.000Z",
      },
      {
