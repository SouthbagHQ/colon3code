...
describe("rightPanelStore", () => {
  ...
  it("tracks one surface per pull request", () => {
    const first = { projectId: "project-a", repository: "SouthbagHQ/colon3code", number: 4909 };
    const second = { projectId: "project-a", repository: "SouthbagHQ/colon3code", number: 4910 };
    useRightPanelStore.getState().openPullRequest(refA, first);
    useRightPanelStore.getState().openPullRequest(refA, second);
    const url = "https://gitlab.example.com/SouthbagHQ/colon3code/-/merge_requests/4909";
