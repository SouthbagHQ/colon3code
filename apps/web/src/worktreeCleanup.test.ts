...
describe("formatWorktreePathForDisplay", () => {
  it("shows only the last path segment for unix-like paths", () => {
    const result = formatWorktreePathForDisplay(
      "/Users/julius/.colon3code/worktrees/colon3code-mvp/colon3code-4e609bb8",
    );
    expect(result).toBe("colon3code-4e609bb8");
  });

  it("normalizes windows separators before selecting the final segment", () => {
    const result = formatWorktreePathForDisplay(
      "C:\\Users\\julius\\.colon3code\\worktrees\\colon3code-mvp\\colon3code-4e609bb8",
    );
    expect(result).toBe("colon3code-4e609bb8");
  });

  it("uses the final segment even when outside ~/.colon3code/worktrees", () => {
