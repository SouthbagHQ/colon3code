...
describe("uiStateStore pure functions", () => {
  ...
  it("stores the sidebar project scope and resets it to all projects", () => {
    const scoped = setSidebarProjectScopeKey(makeUiState(), "github.com/SouthbagHQ/colon3code");

    expect(scoped.sidebarProjectScopeKey).toBe("github.com/SouthbagHQ/colon3code");
    expect(setSidebarProjectScopeKey(scoped, "github.com/SouthbagHQ/colon3code")).toBe(scoped);
...
describe("uiStateStore persistence", () => {
  ...
  it("restores the sidebar project scope across reloads", () => {
    persistState(makeUiState({ sidebarProjectScopeKey: "github.com/SouthbagHQ/colon3code" }));
