...
const VERSION_MISMATCH_DISMISSALS_STORAGE_KEY = "colon3code:version-mismatch-dismissals:v1";
...
/**
 * The skew a user can act on: the connected server runs an older :3 Code than
...
export function resolveVersionMismatch(
  ...
  return {
    ...
    hint: "version mismatch, mrrp. try syncing the client and server to the same :3 Code version.",
  };
}
