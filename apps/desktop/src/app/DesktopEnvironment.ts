...
export class DesktopEnvironment extends Context.Service<
  DesktopEnvironment,
  {
    ...
    // Built web client the packaged renderer is served from over colon3code://app.
...
const make = Effect.fn("desktop.environment.make")(function* (
  ...
  const userDataDirName = isDevelopment ? "colon3code-dev" : "colon3code";
  const legacyUserDataDirName = isDevelopment ? "꞉3 Code (Dev)" : "꞉3 Code (Alpha)";
  ...
  return DesktopEnvironment.of({
    ...
    appUserModelId: Option.getOrElse(config.appUserModelIdOverride, () =>
      isDevelopment ? "com.t3tools.colon3code.dev" : "com.t3tools.colon3code",
    ),
    linuxDesktopEntryName: resolveLinuxDesktopEntryName(isDevelopment),
    linuxWmClass: isDevelopment ? "colon3code-dev" : "colon3code",
