...
<header>↑ Drag :3 Code into the list above</header>
<button id="app" draggable="true" aria-label="Drag :3 Code to System Settings, or click to reveal in Finder"><img src="${escapeHtml(icon)}" alt="" draggable="false">:3 Code</button>
</main></body></html>`;
}
...
export class MacPermissionHelper {
  ...
  async show(
    ...
    if (!appIcon) throw new Error("The packaged :3 Code icon is missing.");
