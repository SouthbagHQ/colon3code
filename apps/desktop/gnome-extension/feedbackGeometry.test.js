...
it("activates only a window of the process authenticated by D-Bus", () => {
  const target = window(42, ":3 Code");
  expect(findCaptureDestination([window(99, ":3 Code"), target], 42, ":3 Code")).toBe(target);
  expect(findCaptureDestination([window(99, ":3 Code")], 42, ":3 Code")).toBeUndefined();
