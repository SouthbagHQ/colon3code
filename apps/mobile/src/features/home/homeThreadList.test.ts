...
describe("buildHomeThreadGroups", () => {
  it("builds one v2 scope for the same repository across environments", () => {
    ...
    expect(scopes[0]?.title).toBe("colon3code");
  ...
  it("routes stale duplicate project refs through the canonical repository group", () => {
    ...
    const local = makeProject({
      ...
      environmentId: localEnvironmentId,
      title: "colon3code",
      workspaceRoot: "/workspaces/colon3code",
      repositoryIdentity,
    });
    const stale = makeProject({
      ...
      title: "colon3code",
      workspaceRoot: "/remote/colon3code",
      updatedAt: "2026-06-01T00:00:00.000Z",
    });
  ...
  it("matches web repository, repository-path, and separate grouping modes", () => {
    ...
    const repositoryIdentity = {
      ...
      name: "colon3code",
      displayName: ":3 Code",
      rootPath: "/workspaces/colon3code",
    };
    const projects = [
      makeProject({
        environmentId,
        ...
        title: "Web",
        workspaceRoot: "/workspaces/colon3code/apps/web",
        repositoryIdentity,
      }),
      makeProject({
        environmentId,
        ...
        title: "Mobile",
        workspaceRoot: "/workspaces/colon3code/apps/mobile",
        repositoryIdentity,
      }),
    ];
    const threads = projects.map((project) =>
  ...
  it("does not apply the recency window while searching", () => {
    ...
    const group = buildGroups([project], threads, { searchQuery: ":3 Code" })[0];
