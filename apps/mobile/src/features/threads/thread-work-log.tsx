...
type WorkContentIcon = AppSymbolName | "browser" | "device" | "colon3-code" | "pull-request";
...
export function ThreadWorkGroupToggle(props: {
  ...
  readonly summaryToolIcon?: "browser" | "device" | "colon3-code" | "pull-request";
  readonly themeAppearance: "light" | "dark";
