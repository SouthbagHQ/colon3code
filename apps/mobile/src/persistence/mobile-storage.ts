...
const CONNECTIONS_KEY = "colon3code.connections";
const AGENT_AWARENESS_DEVICE_ID_KEY = "colon3code.agent-awareness.device-id";
const AGENT_AWARENESS_REGISTRATION_KEY = "colon3code.agent-awareness.registration";
const RECENT_THREAD_SHORTCUTS_KEY = "colon3code.recent-thread-shortcuts";
