...
import {
  ...
  type Colon3CodeToolAvailability,
...
export interface CodexSessionRuntimeOptions {
  ...
  /** Capabilities the session's `colon3-code` MCP credential grants; drives the prompt blocks. */
...
function buildCodexCollaborationMode(input: {
  ...
  readonly browserToolsAvailable?: boolean | Colon3CodeToolAvailability;
