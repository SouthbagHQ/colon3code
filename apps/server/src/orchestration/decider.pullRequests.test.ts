  ...
  it.effect("links the same Forgejo number on two ports and unlinks an older portless record", () =>
    Effect.gen(function* () {
      ...
      const command = yield* decodeCommand({
        ...
        repository: "southbaghq/colon3code",
        number: 42,
        url: "http://forge.example:4000/southbaghq/colon3code/pulls/42",
        source: "manual",
      });
  ...
  it.effect("legacy unlink cannot remove a newer cross-host link", () =>
    Effect.gen(function* () {
      ...
      const foreign = makeLink({
        ...
        url: "https://github.enterprise.test/southbaghq/colon3code/pull/42",
    ...
    Effect.gen(function* () {
      ...
      const command = yield* decodeCommand({
        ...
        linkedPullRequest: {
          ...
          repository: "southbaghq/colon3code",
          number: 99,
          url: "https://github.com/southbaghq/colon3code/pull/99",
        },
      });
