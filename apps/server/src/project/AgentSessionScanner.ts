...
/**
 * :3 Code runs its own agent sessions inside disposable worktrees. Their
 ...
 * worktrees directory plus the conventional `.colon3code/worktrees` layout, which
...
function isT3ManagedWorktree(
  ...
  return (
    ...
    normalized.includes("/.colon3code/worktrees/")
  );
}
