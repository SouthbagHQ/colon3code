...
declare const __COLON3CODE_BUILD_CHANNEL__: "nightly" | "latest" | undefined;

function resolveLoopbackAuthorizationStage(): LoopbackAuthorizationStage {
  return typeof __COLON3CODE_BUILD_CHANNEL__ === "undefined" ? "dev" : __COLON3CODE_BUILD_CHANNEL__;
}

const stageBrands = {
  dev: ":3 Code (Dev)",
  nightly: ":3 Code (Nightly)",
  latest: ":3 Code",
