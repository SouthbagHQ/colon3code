...
const TEST_ENV = {
  COLON3CODE_CLERK_PUBLISHABLE_KEY: "pk_test_Y2xlcmsuZXhhbXBsZS50ZXN0JA==",
  COLON3CODE_CLERK_CLI_OAUTH_CLIENT_ID: "oauth_client_test",
  COLON3CODE_HOSTED_APP_URL: "https://hosted.example.test",
};
