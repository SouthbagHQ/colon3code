...
This directory maintains the [`colon3code-bin`](https://aur.archlinux.org/packages/colon3code-bin) and
[`colon3code-nightly-bin`](https://aur.archlinux.org/packages/colon3code-nightly-bin) packages. Both
