...
const rule = createOxlintRuleHarness("colon3code/no-manual-effect-runtime-in-tests", {
  filename: "fixture.test.ts",
});

describe("colon3code/no-manual-effect-runtime-in-tests", () => {
  rule.valid(
...
const productionRule = createOxlintRuleHarness("colon3code/no-manual-effect-runtime-in-tests");
...
const legacyRule = createOxlintRuleHarness("colon3code/no-manual-effect-runtime-in-tests", {
  filename: "legacy.test.ts",
  ruleOptions: [{ maxOccurrences: 2 }],
});

describe("colon3code/no-manual-effect-runtime-in-tests with maxOccurrences", () => {
  legacyRule.valid(
