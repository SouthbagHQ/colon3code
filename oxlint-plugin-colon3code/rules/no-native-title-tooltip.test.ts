...
const rule = createOxlintRuleHarness("colon3code/no-native-title-tooltip", {
  filename: "fixture.tsx",
});

describe("colon3code/no-native-title-tooltip", () => {
  rule.valid(
  ...
  rule.valid("allows document.title assignments", `document.title = "Thread · :3 Code";`);
