  ...
  embeds: [
    {
      ...
      description:
        options.target === "prerelease"
          ? "A new :3 Code prerelease is available for nightly testers."
          : "A new :3 Code latest release is available.",
...
).pipe(Command.withDescription("Post a :3 Code release announcement to Discord."));
