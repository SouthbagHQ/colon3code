...
export const SHOWCASE_PROJECT_ID = "colon3code";
...
const SHOWCASE_TERMINAL_PROMPT =
  "\u001b[1;32m→\u001b[0m \u001b[1;36mcolon3code\u001b[0m \u001b[1;34mgit:(\u001b[1;31mfeat/remote-command-center\u001b[1;34m)\u001b[0m \u001b[1;33m✗\u001b[0m ";
...
export const SHOWCASE_TERMINAL_BUFFER = [
  ...
  "  \u001b[32m→\u001b[0m  \u001b[2mProject:\u001b[0m  \u001b[1mcolon3code\u001b[0m \u001b[2m— ~/Code/colon3code\u001b[0m",
  "",
...
const PROJECT_FAVICONS = {
  colon3code: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128">
  <rect width="128" height="128" rx="10" fill="#000"/>
  <path d="M35.0875 52.08H44.4475C45.4375 52.08 46.2475 52.89 46.2475 53.88V63.24C46.2475 64.23 45.4375 65.04 44.4475 65.04H35.0875C34.0975 65.04 33.2875 64.23 33.2875 63.24V53.88C33.2875 52.89 34.0975 52.08 35.0875 52.08ZM35.0875 80.04H44.4475C45.4375 80.04 46.2475 80.85 46.2475 81.84V91.2C46.2475 92.19 45.4375 93 44.4475 93H35.0875C34.0975 93 33.2875 92.19 33.2875 91.2V81.84C33.2875 80.85 34.0975 80.04 35.0875 80.04ZM71.5128 93.96C67.6195 93.96 63.7528 93.4533 59.9128 92.44C56.0728 91.3733 52.8195 89.88 50.1528 87.96L55.1928 78.04C57.3261 79.5867 59.8061 80.8133 62.6328 81.72C65.4595 82.6267 68.3128 83.08 71.1928 83.08C74.4461 83.08 77.0061 82.44 78.8728 81.16C80.7395 79.88 81.6728 78.12 81.6728 75.88C81.6728 73.7467 80.8461 72.0667 79.1928 70.84C77.5395 69.6133 74.8728 69 71.1928 69H65.2728V60.44L80.8728 42.76L82.3128 47.4H52.9528V37H92.1525V45.4L76.6328 63.08L70.0728 59.32H73.8328C80.7128 59.32 85.9125 60.8667 89.4325 63.96C92.9525 67.0533 94.7125 71.0267 94.7125 75.88C94.7125 79.0267 93.8865 81.9867 92.2325 84.76C90.5795 87.48 88.0465 89.6933 84.6328 91.4C81.2195 93.1067 76.8461 93.96 71.5128 93.96Z" fill="#fff"/>
</svg>`,
...
export const SHOWCASE_PROJECTS = [
  {
    id: "colon3code",
    title: ":3 Code",
    directory: "colon3code",
    repositoryUrl: "https://github.com/SouthbagHQ/colon3code.git",
    favicon: PROJECT_FAVICONS.colon3code,
  },
  {
    id: "react",
    title: "React",
...
async function seedColon3CodeWorkspace(workspaceRoot: string): Promise<void> {
  ...
  await NodeFSP.writeFile(
    ...
    `${JSON.stringify({ name: "colon3code", private: true, scripts: { test: "vp test" } }, null, 2)}\n`,
  );
  await NodeFSP.writeFile(NodePath.join(workspaceRoot, "favicon.svg"), PROJECT_FAVICONS.colon3code);
  await NodeFSP.writeFile(
...
async function seedCompanionWorkspace(input: {
  ...
  await NodeFSP.writeFile(
    ...
    `# ${input.title}\n\nSeeded by the :3 Code mobile screenshot harness.\n`,
  );
  await initializeRepository({
...
export async function seedShowcaseEnvironment(input: {
  ...
  if (primaryProject.id === SHOWCASE_PROJECT_ID) {
    await seedColon3CodeWorkspace(workspaceRoot);
  }
  await Promise.all(
    projects
