...
const ANDROID_PACKAGE = "com.t3tools.colon3code";
const APP_SCHEME = "colon3code";
...
const IOS_APP_PATH = NodePath.join(
  MOBILE_ROOT,
  ".showcase/ios-derived-data/Build/Products/Debug-iphonesimulator/Colon3Code.app",
);
...
async function buildIos(): Promise<string> {
  ...
  await runCommand(
    ...
    [
      "-workspace",
      NodePath.join(MOBILE_ROOT, "ios/Colon3Code.xcworkspace"),
      "-scheme",
      "Colon3Code",
      "-configuration",
      "Debug",
