...
export interface Colon3CodePublicConfig {
...
export function loadRepoEnv({
  ...
  return {
    ...
    ...(config.clerkPublishableKey
      ? {
          COLON3CODE_CLERK_PUBLISHABLE_KEY: config.clerkPublishableKey,
    ...
    ...(config.clerkJwtTemplate
      ? {
          COLON3CODE_CLERK_JWT_TEMPLATE: config.clerkJwtTemplate,
    ...
    ...(config.clerkCliOAuthClientId
      ? {
          COLON3CODE_CLERK_CLI_OAUTH_CLIENT_ID: config.clerkCliOAuthClientId,
...
export function resolvePublicConfig(...sources: readonly Environment[]): Colon3CodePublicConfig {
  return {
