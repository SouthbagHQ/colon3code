...
// oxlint-disable-next-line colon3code/no-global-process-runtime -- This test launches a real host executable.
const hostPlatform = NodeOS.platform();
// oxlint-disable-next-line colon3code/no-global-process-runtime -- Match the real executable used by the subprocess.
...
it.skipIf(hostPlatform === "win32")(
  ...
  async () => {
    ...
    const executable = NodePath.join(
      root,
      `node_modules/@colon3code/t3-${hostPlatform}-${hostArch}/t3`,
    );
