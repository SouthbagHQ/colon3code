...
export const MOBILE_DEFAULT_THEME_ID = "colon3-code";
...
/**
 * The :3 house palette: a warm, low-chroma blush canvas with a rose accent for
 * light, and a plum canvas for dark. Both built-ins carry both appearances so
 * every surface can render either half; they differ only in which appearance
 * the card leads with.
 */
const COLON3_BLUSH_COLORS: ThemeColors = {
  canvas: "oklch(0.975 0.014 25)",
  chrome: "oklch(0.975 0.014 25)",
  toolbar: "oklch(0.975 0.014 25)",
  toolbarForeground: "oklch(0.33 0.05 15)",
  toolbarBorder: "oklch(0.88 0.03 20)",
  toolbarControl: "oklch(0.94 0.02 22)",
  toolbarControlForeground: "oklch(0.33 0.05 15)",
  toolbarControlHover: "oklch(0.9 0.03 20)",
  surface: "oklch(0.965 0.016 22)",
  surfaceRaised: "oklch(0.985 0.008 25)",
  surfaceOverlay: "oklch(0.995 0.004 25)",
  text: "oklch(0.33 0.05 15)",
  textMuted: "oklch(0.5465 0.06 12)",
  border: "oklch(0.9 0.025 20)",
  input: "oklch(0.86 0.035 18)",
  focus: "oklch(0.585 0.2 8)",
  accent: "oklch(0.585 0.2 8)",
  accentForeground: "oklch(1 0 0)",
  secondary: "oklch(0.91 0.035 20)",
  secondaryForeground: "oklch(0.4 0.06 15)",
  muted: "oklch(0.93 0.025 22)",
  mutedForeground: "oklch(0.48 0.06 12)",
  placeholder: "oklch(0.56 0.05 15)",
  secondaryLabel: "oklch(0.5465 0.06 12)",
  iconMuted: "oklch(0.5465 0.06 12)",
  error: "oklch(0.6 0.22 20)",
  errorForeground: "oklch(0.46 0.17 18)",
  errorSurface: "oklch(0.94 0.03 15)",
  warning: "oklch(0.76859 0.164659 70.08)",
  warningForeground: "oklch(0.54612 0.143036 48.949)",
  warningSurface: "oklch(0.962901 0.015297 48.56)",
  update: "oklch(0.585 0.2 8)",
  updateForeground: "oklch(0.48 0.17 8)",
  updateSurface: "oklch(0.93 0.035 15)",
  accentSurface: "oklch(0.935 0.03 18)",
  accentSurfaceForeground: "oklch(0.4 0.06 15)",
  messageSurface: "oklch(0.925 0.035 18)",
  messageForeground: "oklch(0.35 0.06 15)",
  messageAction: "oklch(0.585 0.2 8)",
  messageActionForeground: "oklch(1 0 0)",
  messageActionHover: "oklch(0.54 0.19 8)",
  codeBackground: "oklch(0.95 0.018 22)",
  codeForeground: "oklch(0.42 0.07 12)",
  sidebar: "oklch(0.945 0.022 22)",
  sidebarForeground: "oklch(0.38 0.045 15)",
  sidebarMutedForeground: "oklch(0.52 0.05 12)",
  sidebarControlSurface: "oklch(0.975 0.012 25)",
  sidebarRowHover: "oklch(0.965 0.016 24)",
  sidebarRowActive: "oklch(0.9 0.035 20)",
  sidebarRowSelected: "oklch(0.88 0.045 18)",
  sidebarBorder: "oklch(0.9 0.025 20)",
  terminalBackground: "oklch(0.975 0.014 25)",
  terminalForeground: "oklch(0.33 0.05 15)",
  terminalCursor: "oklch(0.585 0.2 8)",
  terminalSelection: "oklch(0.88 0.05 15)",
  terminalScrollbar: "oklch(0.86 0.035 18)",
  terminalScrollbarHover: "oklch(0.8 0.05 15)",
};

const COLON3_PLUM_COLORS: ThemeColors = {
  canvas: "oklch(0.22 0.03 330)",
  chrome: "oklch(0.22 0.03 330)",
  toolbar: "oklch(0.22 0.03 330)",
  toolbarForeground: "oklch(0.93 0.015 340)",
  toolbarBorder: "oklch(0.29 0.03 330)",
  toolbarControl: "oklch(0.3 0.035 330)",
  toolbarControlForeground: "oklch(0.88 0.03 340)",
  toolbarControlHover: "oklch(0.35 0.045 330)",
  surface: "oklch(0.255 0.03 330)",
  surfaceRaised: "oklch(0.285 0.03 330)",
  surfaceOverlay: "oklch(0.17 0.025 330)",
  text: "oklch(0.93 0.015 340)",
  textMuted: "oklch(0.639 0.035 340)",
  border: "oklch(0.31 0.03 330)",
  input: "oklch(0.34 0.04 335)",
  focus: "oklch(0.7 0.19 5)",
  accent: "oklch(0.7 0.19 5)",
  accentForeground: "oklch(0.18 0.04 340)",
  secondary: "oklch(0.32 0.035 330)",
  secondaryForeground: "oklch(0.88 0.03 340)",
  muted: "oklch(0.34 0.03 330)",
  mutedForeground: "oklch(0.74 0.035 340)",
  placeholder: "oklch(0.67 0.035 335)",
  secondaryLabel: "oklch(0.639 0.035 340)",
  iconMuted: "oklch(0.639 0.035 340)",
  error: "oklch(0.68 0.2 15)",
  errorForeground: "oklch(0.8 0.1 10)",
  errorSurface: "oklch(0.3 0.06 10)",
  warning: "oklch(0.76859 0.164659 70.08)",
  warningForeground: "oklch(0.836861 0.164422 84.429)",
  warningSurface: "oklch(0.321706 0.036256 60.806)",
  update: "oklch(0.7 0.19 5)",
  updateForeground: "oklch(0.86 0.08 350)",
  updateSurface: "oklch(0.32 0.06 350)",
  accentSurface: "oklch(0.34 0.05 340)",
  accentSurfaceForeground: "oklch(0.95 0.015 340)",
  messageSurface: "oklch(0.31 0.045 340)",
  messageForeground: "oklch(0.95 0.015 340)",
  messageAction: "oklch(0.7 0.19 5)",
  messageActionForeground: "oklch(0.18 0.04 340)",
  messageActionHover: "oklch(0.74 0.17 5)",
  codeBackground: "oklch(0.19 0.028 330)",
  codeForeground: "oklch(0.86 0.05 340)",
  sidebar: "oklch(0.19 0.028 330)",
  sidebarForeground: "oklch(0.95 0.01 340)",
  sidebarMutedForeground: "oklch(0.639 0.035 340)",
  sidebarControlSurface: "oklch(0.25 0.035 335)",
  sidebarRowHover: "oklch(0.25 0.035 335)",
  sidebarRowActive: "oklch(0.29 0.045 335)",
  sidebarRowSelected: "oklch(0.31 0.05 337)",
  sidebarBorder: "oklch(0.27 0.035 335)",
  terminalBackground: "oklch(0.22 0.03 330)",
  terminalForeground: "oklch(0.93 0.015 340)",
  terminalCursor: "oklch(0.7 0.19 5)",
  terminalSelection: "oklch(0.36 0.06 340)",
  terminalScrollbar: "oklch(0.34 0.04 335)",
  terminalScrollbarHover: "oklch(0.42 0.04 335)",
};

export const COLON3_THEME: ThemeDefinition = {
  id: "colon3",
  label: ":3 Blush",
  appearance: "light",
  colors: COLON3_BLUSH_COLORS,
  variants: { dark: COLON3_PLUM_COLORS },
  sidebarArtwork: true,
};

export const COLON3_DARK_THEME: ThemeDefinition = {
  id: "colon3-dark",
  label: ":3 Plum",
  appearance: "dark",
  colors: COLON3_PLUM_COLORS,
  variants: { light: COLON3_BLUSH_COLORS },
  sidebarArtwork: true,
};
