 ...
 * executable in the sibling `@colon3code/t3-<platform>-<arch>` package.
 *
...
const executable = join(dirname(require.resolve("@colon3code/t3-" + process.platform + "-" + process.arch + "/package.json")), executableName);
