 ...
 * machine into a :3 Code browser profile.
 *
...
export const BrowserImportInput = Schema.Struct({
  ...
  /** :3 Code profile the cookies are written into. */
...
const BROWSER_IMPORT_UNAVAILABLE_COPY: Readonly<Record<BrowserImportUnavailableReason, string>> = {
  ...
  needsFullDiskAccess:
    "Give :3 Code Full Disk Access in System Settings → Privacy & Security, then retry.",
